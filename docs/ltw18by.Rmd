...
Für die folgende Analyse wurden alle Tweets gesammelt, die das Wort "ltw18by" beinhalten. Den Link zum Notebook gibts [hier](https://github.com/franziloew/Ltw19by/blob/master/docs/ltw18by.Rmd)
